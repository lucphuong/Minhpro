...
hooks.TanHinh=function(enable) if enable then safeLoadFromUrl("TanHinh","https://abre.ai/invisible-v2") else tryCleanup("TanHinh") end end
...
hooks.FeFlip=function(enable) if enable then safeLoadFromUrl("FeFlip","https://pastebin.com/raw/abcd1234") else tryCleanup("FeFlip") end end
...
createMenu()
print("✅ RedMenuAll loaded (4-column, centered, drag enabled, safe, pcall).")
