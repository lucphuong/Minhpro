...
pcall(function()
    ...
    hooks.LaserGun = function(enable)
        if enable then
            ...
            safeLoadFromUrl("LaserGun", "https://raw.githubusercontent.com/lucphuong/1x1x1x1x1/refs/heads/main/Lasergun.lua?token=GHSAT0AAAAAADMAEXZDBRUBA3FMM4YW3XAC2HVZGUA")
