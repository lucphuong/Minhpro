-- RED MENU ALL-IN-ONE (SAFE) 2-COLUMN, DRAGGABLE
...
hooks.BatTu = function(enable)
    workspace.FallenPartsDestroyHeight = enable and 0/0 or -1000
end
...
hooks.FeFlip = function(enable)
    if enable then
        safeLoadFromUrl("FeFlip","https://pastebin.com/raw/abcd1234")
    else
        tryCleanup("FeFlip")
    end
end

-- Create 2-column draggable menu
local function createMenu()
    ...
    local btnWidth = (frame.Size.X.Offset-30)/2
    local btnHeight = 44
...
createMenu()
print("✅ RedMenuAll loaded (2-column, drag enabled, safe, pcall)")
